              ...
              >
                ...
                >
                    ...
                    >
                        ...
                        {/* Optional extra quick link to use GitBranch + TrendingUp */}
                        <QuickLink
                            to="/reports"
                            title="Reports & Insights"
                            desc="Track invoice totals, conversion rate, and trends."
...
const QuickLink = ({
    ...
    >
        ...
        <div style={{ flex: 1 }}>
            <div style={{ fontWeight: 700, color: "var(--color-text)", fontSize: "16px" }}>
                {title}
            </div>
            <div
                style={{
